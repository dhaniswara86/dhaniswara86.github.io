  ...
  function renderOpWbtClassic(schema) {
    ...
    const field = (id, label, required=false, type='text', extra='') => `
      <div class="opwbt-field-row ${extra}">
        ...
        <span class="colon">:</span>
        <input id="${escapeHtml(id)}" class="opwbt-charline" type="${escapeHtml(type)}"
    ...
    const textAreaField = (id, label, required=false, rows=2) => `
      <div class="opwbt-field-row opwbt-field-tall">
        <label for="${escapeHtml(id)}">${escapeHtml(label)}</label>
        <span class="colon">:</span>
        <textarea id="${escapeHtml(id)}" class="opwbt-chararea" rows="${rows}"
          ${required ? 'data-required="true"' : ''}
      ...
      <section class="opwbt-address-block">
        ...
        <div class="opwbt-address-inline">
          <div class="opwbt-field-row">
            ...
            <span class="colon">:</span>
            <input id="${prefix}Nomor" class="opwbt-charline" type="text" data-label="Nomor">
          </div>
          <div class="opwbt-rt-rw">
            <label>RT/RW</label>
            <input id="${prefix}Rt" class="opwbt-charline opwbt-smallbox" type="text" aria-label="RT">
            <span>/</span>
            <input id="${prefix}Rw" class="opwbt-charline opwbt-smallbox" type="text" aria-label="RW">
          </div>
        </div>
    ...
    const kluField = (id) => `
      <div class="opwbt-klu">
        ...
        <input id="${escapeHtml(id)}" class="opwbt-charline opwbt-klu-box" type="text" maxlength="5" aria-label="KLU">
    ...
    const incomeEntry = (prefix, label, secondFieldLabel, withBrand=false) => `
      <div class="opwbt-income-entry">
        <div class="opwbt-income-main">
          <textarea id="${prefix}Uraian" class="opwbt-chararea opwbt-income-box" rows="3" aria-label="${escapeHtml(label)}"></textarea>
          ${kluField(prefix + 'Klu')}
        </div>
    ...
    const bookkeepingBlock = (prefix, withEmployee=false) => `
      ...
      <div class="opwbt-period-row">
        ...
        <input id="${prefix}PeriodeMulai" class="opwbt-charline opwbt-period-box" type="text" aria-label="Periode pembukuan mulai">
        <span>s.d.</span>
        <input id="${prefix}PeriodeAkhir" class="opwbt-charline opwbt-period-box" type="text" aria-label="Periode pembukuan akhir">
      </div>`;
    ...
    root.innerHTML = `
      ...
      <section class="opwbt-section">
        ...
        <div class="opwbt-field-row opwbt-birth-row">
          ...
          <div class="opwbt-birth-fields">
            <input id="tempatLahir" class="opwbt-charline" type="text" data-required="true" data-label="Tempat lahir">
            <span>/</span>
            <input id="tanggalLahir" class="opwbt-charline opwbt-date-box" type="text" placeholder="tgl-bln-thn"
      ...
      <section class="opwbt-section opwbt-statement">
