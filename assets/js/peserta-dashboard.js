...
function bindStaticEvents() {
  ...
  document
    .getElementById("closeScoreModal")
    ?.addEventListener(
      "click",
      () =>
        document
...
function renderSummary() {
  ...
  document
    .getElementById("summaryClasses")
    .textContent =
      summary.active_class_count ?? 0;
  ...
  document
    .getElementById("summaryCompleted")
    .textContent =
      summary.completed_class_count ?? 0;
...
function renderJourneyCard(classData) {
  ...
  const materialDone =
    classData.lessons_total > 0 &&
    classData.lessons_completed >=
      classData.lessons_total;


  const quizzesDone =
    classData.quizzes_total > 0 &&
    classData.quizzes_passed >=
      classData.quizzes_total;


  const finalDone =
    classData.final_passed === true;
  ...
  const steps = [
    {
      label: "Materi",
      value:
        `${classData.lessons_completed}/${classData.lessons_total}`,
      done: materialDone,
      active:
        !materialDone
    },
    {
      label: "Kuis Modul",
      value:
        `${classData.quizzes_passed}/${classData.quizzes_total}`,
      done: quizzesDone,
      active:
        materialDone &&
        !quizzesDone
    },
    {
      label: "Evaluasi",
      value:
        classData.final_best_score == null
          ? "—"
          : String(
              classData.final_best_score
            ),
      done: finalDone,
      active:
        materialDone &&
    ...
    <article class="learning-journey-card">
      ...
      <div class="learning-journey-top">
        ...
        <div>
          ...
          <div class="learning-journey-label">
            ${classData.is_active ? "Kelas Aktif" : "Kelas"}
          </div>
      ...
      <div class="journey-progress-track">
        <span
          style="width:${clampPercent(classData.progress_percent)}%">
        </span>
      </div>
      ...
      <div class="journey-actions">
        ...
        <a
          class="participant-button class-primary"
        ...
        <button
          type="button"
          class="participant-button score-history-button"
    ...
    host.innerHTML = `
      <div class="certificate-empty-state">
        ...
        <div>
          ...
          <p>
            Sertifikat akan tersedia setelah seluruh syarat
            kelulusan terpenuhi dan pengajar menerbitkannya.
          </p>
        </div>
    ...
    <article class="participant-class-card extended">
      ...
      <div class="participant-class-main">
        ...
        <div class="participant-class-number">
          ${classData.is_active ? "Aktif" : "Kelas"}
        </div>
        ...
        <div class="participant-class-copy">
          ...
          <div class="participant-class-progress">
            ...
            <small>
              ${classData.lessons_completed}/${classData.lessons_total}
              checkpoint · ${classData.progress_percent || 0}%
            </small>
      ...
      <div class="class-score-preview">
        ...
        <button
          type="button"
          class="score-preview-detail score-history-button"
          data-class-id="${classData.id}">
          Lihat riwayat
        </button>
...
function bindScoreHistoryButtons() {
  ...
  document
    .querySelectorAll(
      ".score-history-button[data-class-id]"
    )
    .forEach(button => {
...
function openScoreHistory(classId) {
  ...
  document
    .getElementById("scoreModuleList")
    .innerHTML =
      moduleResults
        .map(result => {
          ...
          return `
            <article class="score-module-card">
              ...
              <span class="score-module-state ${result.passed ? "passed" : ""}">
  ...
  document
    .getElementById("scoreFinalCard")
    .innerHTML = `
      <div>

        <div class="participant-section-kicker">
          Evaluasi Akhir
        </div>
        ...
        <p>
          Nilai minimum ${classData.final_pass_score ?? 70}.
        </p>
      ...
      <div class="score-final-number">
        ...
        <small>
          ${classData.final_attempts || 0}/${classData.final_max_attempts ?? "∞"}
          percobaan
        </small>
      ...
      <div class="score-final-status">
        ...
        <span class="${classData.final_passed ? "passed" : ""}">
          ${classData.final_passed ? "Lulus" : "Belum lulus"}
        </span>
...
function getContinueLabel(
  ...
  if (!materialDone) {
    return "Lanjutkan materi";
  }


  if (!quizzesDone) {
    return "Lanjutkan kuis";
  }


  if (!finalDone) {
    return "Kerjakan Evaluasi";
  }
...
function renderPageError(message) {
  ...
  document
    .getElementById("learningJourneyList")
    .innerHTML =
      html;
