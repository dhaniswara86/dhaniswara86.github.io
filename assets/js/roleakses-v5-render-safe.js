(() => {
  ...
  const showSlide = (index) => {
    ...
    thumbs.forEach((thumb, thumbIndex) => {
      ...
      if (isActive) {
        ...
        /* Safe render: jangan pindahkan scroll halaman dari thumbnail. */
      } else {
  ...
  /*
   * Initial load tidak boleh memindahkan viewport ke area presentasi.
   * Auto-scroll thumbnail hanya berjalan setelah interaksi pengguna.
   */
})();
