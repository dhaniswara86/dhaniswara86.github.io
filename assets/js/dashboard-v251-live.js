...
Dashboard Pengajar + Detail Peserta
====================================================
*/
...
async function getParticipants(client,classId){
...
async function getEvaluations(client,classId){
...
function updateSummary(
    ...
    if(cards.length >=4){
        ...
        cards[3].innerText =
        `${kelas.total_checkpoint} checkpoint`;
...
function renderParticipants(
    ...
    peserta.map(
        p => {
            ...
            if(checkpointSelesai >= kelas.total_checkpoint)
                status="🟢 Selesai";
            ...
            <button
            class="detail-btn"
            onclick="openParticipantDetail('${p.id}')">
