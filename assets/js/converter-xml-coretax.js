...
const FORMAT_ORDER = ["BPMP","BP21","BP26","BPA1","BPA2","BPPU","BPNR","BPSP","BPCY","DDBU","FPK","RPM","LAMPC","DLK","DLM","RDLK","RDLM","SPTL3B","SPTL9","SPTL10A","SPTL11PROMO","SPTL11ENT","SPTL11PIUTANG","SPTL11KREDIT","SPTPENC"];
...
function renderFormatSelect() {
  ...
  const groups = ["PPh Pasal 21/26", "PPh Unifikasi", "e-Faktur / PPN", "Dokumen Lain / PPN", "SPT Tahunan PPh Badan"];
...
function selectFormat(code) {
  ...
  if (els.summaryTinLabel) els.summaryTinLabel.textContent = f.family === "sptBadan" ? (f.special === "sptL9" ? "Identitas" : "NPWP SPT") : "NPWP Pemotong";
  if (ot) {
