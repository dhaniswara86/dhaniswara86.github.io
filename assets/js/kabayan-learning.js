(() => {
  ...
  const el = {
    ...
    participantCohort: document.getElementById("participantCohort"),
  ...
  function showIdentity() {
    ...
    el.participantCohort.value = state.profile?.cohort || "";
  ...
  function handleIdentitySubmit(event) {
    ...
    const cohort = cleanName(el.participantCohort.value);
  ...
  async function finishQuiz() {
    ...
    const attempt = {
      ...
      cohort_name: state.profile.cohort || null,
      module_id: MODULE_ID,
