...
<li>Akun Coretax sudah dapat digunakan untuk login.</li>
<li>NIK atau NPWP yang tampil pada profil sudah benar.</li>
<li>Nama Wajib Pajak sesuai dengan data administrasi.</li>
<li>Alamat email aktif dan dapat diakses.</li>
<li>Nomor telepon seluler sudah sesuai.</li>
<li>Pengguna menyiapkan passphrase yang hanya diketahui sendiri.</li>
</ul>
